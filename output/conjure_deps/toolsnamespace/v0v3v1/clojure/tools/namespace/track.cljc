...
(ns conjure-deps.toolsnamespace.v0v3v1.clojure.tools.namespace.track
  (:refer-clojure :exclude (remove))
  (:require [clojure.set :as set]
            [conjure-deps.toolsnamespace.v0v3v1.clojure.tools.namespace.dependency :as dep]))
...
(defn add
  ...
  have two lists associated with the following keys:
      ...
      :conjure-deps.toolsnamespace.v0v3v1.clojure.tools.namespace.track/unload
          is the list of namespaces that need to be removed

      :conjure-deps.toolsnamespace.v0v3v1.clojure.tools.namespace.track/load
  ...
  'load' list. The conjure-deps.toolsnamespace.v0v3v1.clojure.tools.namespace.reload namespace has
...
(comment
  ...
  {;; Dependency graph of namespace names (symbols) as defined in
   ;; conjure-deps.toolsnamespace.v0v3v1.clojure.tools.namespace.dependency/graph
   :conjure-deps.toolsnamespace.v0v3v1.clojure.tools.namespace.track/deps {}
   ...
   ;; Added by conjure-deps.toolsnamespace.v0v3v1.clojure.tools.namespace.file: Map from source files
   ;; (java.io.File) to the names (symbols) of namespaces they
   ;; represent.
   :conjure-deps.toolsnamespace.v0v3v1.clojure.tools.namespace.file/filemap {}

   ;; Added by conjure-deps.toolsnamespace.v0v3v1.clojure.tools.namespace.dir: Set of source files
   ;; (java.io.File) which have been seen by this dependency tracker;
   ;; used to determine when files have been deleted.
   :conjure-deps.toolsnamespace.v0v3v1.clojure.tools.namespace.dir/files #{}

   ;; Added by conjure-deps.toolsnamespace.v0v3v1.clojure.tools.namespace.dir: Instant when the
   ;; directories were last scanned, as returned by
   ;; System/currentTimeMillis.
   :conjure-deps.toolsnamespace.v0v3v1.clojure.tools.namespace.dir/time 1405201862262})
