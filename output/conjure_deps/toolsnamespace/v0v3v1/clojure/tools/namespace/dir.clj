...
(ns conjure-deps.toolsnamespace.v0v3v1.clojure.tools.namespace.dir
  (:require [conjure-deps.toolsnamespace.v0v3v1.clojure.tools.namespace.file :as file]
            [conjure-deps.toolsnamespace.v0v3v1.clojure.tools.namespace.find :as find]
            [conjure-deps.toolsnamespace.v0v3v1.clojure.tools.namespace.track :as track]
            [conjure-deps.javaclasspath.v0v3v0.clojure.java.classpath :refer [classpath-directories]]
...
(defn scan-files
  ...
  Optional third argument is map of options:
    ...
    :platform  Either clj (default) or cljs, both defined in
               conjure-deps.toolsnamespace.v0v3v1.clojure.tools.namespace.find, controls reader options for 
               parsing files.
...
(defn scan-dirs
  ...
  Optional third argument is map of options:
    ...
    :platform  Either clj (default) or cljs, both defined in 
               conjure-deps.toolsnamespace.v0v3v1.clojure.tools.namespace.find, controls file extensions 
               and reader options.
