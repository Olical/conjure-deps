...
(ns 
  conjure-deps.toolsnamespace.v0v3v1.clojure.tools.namespace.find
  (:require [conjure-deps.javaclasspath.v0v3v0.clojure.java.classpath :as classpath]
            [clojure.java.io :as io]
            [clojure.set :as set]
            [conjure-deps.toolsnamespace.v0v3v1.clojure.tools.namespace.file :as file]
            [conjure-deps.toolsnamespace.v0v3v1.clojure.tools.namespace.parse :as parse])
...
(defn find-sources-in-dir
  ...
  defined in conjure-deps.toolsnamespace.v0v3v1.clojure.tools.namespace.find."
  {:added "0.3.0"}
  ([dir]
...
(defn find-ns-decls-in-dir
  ...
  both defined in conjure-deps.toolsnamespace.v0v3v1.clojure.tools.namespace.find."
  {:added "0.2.0"}
...
(defn find-ns-decls
  ...
  forms. Use with conjure-deps.javaclasspath.v0v3v0.clojure.java.classpath to search Clojure's
  classpath.
...
(defn find-namespaces
  ...
  namespaces. Use with conjure-deps.javaclasspath.v0v3v0.clojure.java.classpath to search Clojure's
  classpath.
