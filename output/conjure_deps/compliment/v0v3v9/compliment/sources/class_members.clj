(ns conjure-deps.compliment.v0v3v9.compliment.sources.class-members
  "Completion for both static and non-static class members."
  (:require [conjure-deps.compliment.v0v3v9.compliment.sources :refer [defsource]]
            [conjure-deps.compliment.v0v3v9.compliment.sources.local-bindings :refer [bindings-from-context]]
            [conjure-deps.compliment.v0v3v9.compliment.utils :refer [fuzzy-matches-no-skip? resolve-class]]
