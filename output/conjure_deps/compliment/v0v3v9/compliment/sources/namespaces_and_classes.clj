(ns conjure-deps.compliment.v0v3v9.compliment.sources.namespaces-and-classes
  "Completion for namespace and class names."
  (:require [conjure-deps.compliment.v0v3v9.compliment.sources :refer [defsource]]
            [conjure-deps.compliment.v0v3v9.compliment.utils :refer [fuzzy-matches?] :as utils]
            [conjure-deps.compliment.v0v3v9.compliment.sources.class-members :refer [classname-doc]])
  (:import java.io.File))
