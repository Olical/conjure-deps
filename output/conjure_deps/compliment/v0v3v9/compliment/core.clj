...
(ns conjure-deps.compliment.v0v3v9.compliment.core
  "Core namespace. Most interactions with Compliment should happen
  through functions defined here."
  (:require (conjure-deps.compliment.v0v3v9.compliment.sources ns-mappings
                                ...
                                local-bindings
                                resources)
            [conjure-deps.compliment.v0v3v9.compliment.sources :refer [all-sources]]
            [conjure-deps.compliment.v0v3v9.compliment.context :refer [cache-context]]
            [conjure-deps.compliment.v0v3v9.compliment.utils :refer [*extra-metadata*]]
