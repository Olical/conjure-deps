...
(ns conjure-deps.toolsreader.v1v3v2.clojure.tools.reader.edn
  ...
  (:require [conjure-deps.toolsreader.v1v3v2.clojure.tools.reader.reader-types :refer
            ...
            [conjure-deps.toolsreader.v1v3v2.clojure.tools.reader.impl.utils :refer
            ...
            [conjure-deps.toolsreader.v1v3v2.clojure.tools.reader :refer [default-data-readers]])
...
(defn read
  "Reads the first object from an IPushbackReader or a java.io.PushbackReader.
   ...
   conjure-deps.toolsreader.v1v3v2.clojure.tools.reader.edn/read doesn't depend on dynamic Vars, all configuration
...
(defn read-string
  "Reads one object from the string s.
   ...
   opts is a map as per conjure-deps.toolsreader.v1v3v2.clojure.tools.reader.edn/read"
